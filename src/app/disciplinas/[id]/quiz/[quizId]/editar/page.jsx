  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 bg-white">
        <div className="container mx-auto max-w-4xl px-4 sm:px-6 py-10 relative">
          <button
            onClick={() => router.push(`/disciplinas/${disciplinaId}/quiz/${quizId}/associar`)}
            className="absolute top-10 right-4 px-4 py-2 bg-purple-700 text-white rounded-lg hover:bg-purple-800 transition-colors"
          >
            Adicionar Questões
          </button>
